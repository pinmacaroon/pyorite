...
public class ArchPlush extends Block {

    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    protected final Random random = Random.create();

    public ArchPlush(Settings settings) {
        super(settings);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        world.playSoundAtBlockCenter(pos, SoundEvents.ENTITY_CAT_PURREOW, SoundCategory.BLOCKS, 1F, RandomGenerator.getDefault().nextFloat(0.8F, 1.2F), true);
